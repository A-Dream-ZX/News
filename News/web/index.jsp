        ...
        <div class="content">
            ...
            <ul>
                ...
                <p align="right">
                    ...
                    <a href="${pageContext.request.contextPath}/NewsServlet?action=news&tid=ntid&pageNo=1">首页</a>
                    <a href="${pageContext.request.contextPath}/NewsServlet?action=news&tid=ntid&pageNo=${prev}">&nbsp;&nbsp;上一页</a>
                    <a href="${pageContext.request.contextPath}/NewsServlet?action=news&tid=ntid&pageNo=${next}">&nbsp;&nbsp;下一页</a>
                    <a href="${pageContext.request.contextPath}/NewsServlet?action=news&tid=ntid&pageNo=${allPages}">&nbsp;&nbsp;末页</a>
                </p>
            </ul>
        </div>
        <%-- 右侧图片--%>
